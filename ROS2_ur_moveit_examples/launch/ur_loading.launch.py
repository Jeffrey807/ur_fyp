...
def launch_setup(context, *args, **kwargs):
    ...
    # UR Loading C++ node - Custom Motion Sequence with Suction Control
    ur_loading_node = Node(
        package="ros2_ur_moveit_examples",
        executable="ur_loading",
        name="ur_loading",
        output="screen",
        parameters=[
            robot_description,
    ...
    nodes_to_start = [move_group_node, rviz_node, ur_loading_node]
