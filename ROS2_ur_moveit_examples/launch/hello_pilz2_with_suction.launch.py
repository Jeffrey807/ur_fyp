...
def launch_setup(context, *args, **kwargs):
    ...
    warehouse_config = {
        ...
        "warehouse_host": str(warehouse_sqlite_path.perform(context)),
    }
    ...
    # Hello Pilz2 with Suction C++ node - Custom Motion Sequence with Suction Control
    hello_pilz2_with_suction_node = Node(
        package="ros2_ur_moveit_examples",
        executable="hello_pilz2_with_suction",
        name="hello_pilz2_with_suction",
        output="screen",
        parameters=[
            robot_description,
            robot_description_semantic,
    ...
    nodes_to_start = [move_group_node, rviz_node, hello_pilz2_with_suction_node]
...
def generate_launch_description():
    ...
    declared_arguments.append(
        ...
        multi-robot setup. If changed than also joint names in the controller's configuration \
        have to be updated.",
        )
    )
    declared_arguments.append(
